...
import { ThemeProvider, ColorModeProvider } from '@wttj/xstyled-styled-components'
import App from './App'
...
```js
import React from 'react'
import { useColorMode } from '@wttj/xstyled-styled-components'
...
```js
import React from 'react'
import { getColorModeInitScriptElement } from '@wttj/xstyled-styled-components'
