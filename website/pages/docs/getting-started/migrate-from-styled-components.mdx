...
`@wttj/xstyled-styled-components` is a drop-in replacement for `styled-components`. You can safely replace `styled-components` by `@wttj/xstyled-styled-components`.
...
module.exports = {
  ...
  // Other macros config
  styledComponents: {
    importModuleName: '@wttj/xstyled-styled-components',
  },
}
```
